...
//---- input parameters
extern   int      order_delta    =  20;   // difference between buy and sell orders
extern   int      stop_loss      =  100;  // initial stop loss level
extern   int      return_level   =  50;   // when to set take profit equal to buy price
extern   double   trailing_level =  0.5;  // trail at 50%
extern   int      trade_period   =  900;    // how often to trade in seconds
