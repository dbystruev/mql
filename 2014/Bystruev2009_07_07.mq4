...
//|          Copyright © 2009, Denis Bystruev, 24 June - 7 July 2009 |
//|                                           http://www.moeradio.ru |
//+------------------------------------------------------------------+
#property copyright "Copyright © 2009, Denis Bystruev, 24 June - 7 July 2009"
#property link      "http://www.moeradio.ru"

#define  MAGIC_NUMBER   320090707
...
int start() {
   ...
   switch (total_orders()) {
      case 0:
         ...
         break;
      case 1:
         if (total_orders(OP_BUY, OP_SELL) == 0) delete_orders(OP_BUYSTOP, OP_SELLSTOP);
         break;
      case 2:
